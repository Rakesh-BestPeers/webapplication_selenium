...
Scenario Outline: XCHEKLAB_2035 :: As an xChekVet company user, I should have an option to manipulate the baseline so that I can update the existing criteria baseline details.
