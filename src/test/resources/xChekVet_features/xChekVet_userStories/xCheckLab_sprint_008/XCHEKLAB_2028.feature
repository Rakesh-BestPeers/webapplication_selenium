...
Scenario Outline: XCHEKLAB_2028 :: As an xChekVet company User, I should be able to navigate the "Select data" screen from Select data so that I can select the data to create the Criteria-Based baseline
