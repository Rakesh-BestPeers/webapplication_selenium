...
Scenario Outline: XCHEKLAB_1680 :: As a xCheckvet Compnay user, I should have an option to upload the custom logo on "View Report" of multiple case So that I can upload the logo of my choice.
