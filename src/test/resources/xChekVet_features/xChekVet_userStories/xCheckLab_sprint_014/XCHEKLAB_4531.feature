...
Scenario Outline: XCHEKLAB_4531 :: As an xChek Vet User, I should be able to navigate to the "Define data Groups" screen so that I can see the default view of the Define groups screen while generating the GMT Time Series report
